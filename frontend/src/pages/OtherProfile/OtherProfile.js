...
const OtherProfile = ({ user }) => {
    ...
    useEffect(() => {
        ...
        fetch(`${process.env.REACT_APP_BACKEND_URL}/userBadges?email=${email}`)
            .then(res => res.json())
            .then(data => setBadges(data));

        if (loggedInUser) {
            fetch(`${process.env.REACT_APP_BACKEND_URL}/user?email=${email}`)
                .then(res => res.json())
                .then(data => {
    ...
    const handleFollow = async () => {
        try {
            ...
            const response = await axios.patch(`${process.env.REACT_APP_BACKEND_URL}/followUser/${email}`, { followerEmail });
    ...
    const handlePointTransfer = async () => {
        try {
            const response = await axios.post(`${process.env.REACT_APP_BACKEND_URL}/transferPoints`, {
