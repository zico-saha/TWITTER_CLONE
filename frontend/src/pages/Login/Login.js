...
const Login = () => {
    ...
    const sendOtp = async (toEmail) => {
        try {
            ...
            console.log(error);
            alert('Failed to send OTP'); // Handle errors in sending OTP
        }
    };
    ...
    const handleOtpSubmit = async () => {
        if (enteredOTP === OTP) {
            ...
            alert("Invalid OTP"); // Show error message for invalid OTP
        }
    };
        ...
        try {
            ...
            if (userInfo.device === 'Mobile') {
                ...
                if (currentHour < 8 || currentHour > 18) {
                    alert("Login/Sign-In is allowed only between 8:00 AM and 6:00 PM.");
                    return;
                }
            }
